    ...
    <main class="app-content">
        <div class="app-title">
            <ul class="app-breadcrumb breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('chi-tiet-admin', ['id' => $user->id]) }}">Thông tin quản trị
                        viên</a></li>
            </ul>
        </div>
        <div class="row">
                ...
                <div class="tile">
                    ...
                    <div class="tile-body">
                        <form class="row" action="{{ route('chi-tiet-admin', ['id' => $user->id]) }}" method="POST"
                            ...
                            <input class="form-control" name="password" type="password" required value="{{$user->password}}">
                        </div> --}}
                            <div class="form-group col-md-6">
